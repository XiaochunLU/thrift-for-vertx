...
var InputBufferUnderrunError = exports.InputBufferUnderrunError = util.subclassError('InputBufferUnderrunError');

// Base class for transport
var TTransport = function(inputBuffer, flushCallback) {
  this.inputBuffer = inputBuffer;
  this.setFlushCallback(flushCallback);
  this.resetOutputBuffer();
};
TTransport.prototype.setFlushCallback = function(flushCallback) {
  this.onFlush = flushCallback;
};
...
var TEventBusServerTransport = exports.TEventBusServerTransport = function(inputBuffer, flushCallback) {
  TTransport.call(this, inputBuffer, flushCallback);
};
...
var TEventBusTransport = exports.TEventBusTransport = function(inputBuffer, flushCallback) {
  TTransport.call(this, inputBuffer, flushCallback);
};
