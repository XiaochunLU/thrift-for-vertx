...
/** 
 * Create a Thrift server which transports messages through the TCP/TLS socket.
 ...
 */
exports.createFramedNetServer = function(processor, options) {
  if (!options || !options.port)
    throw 'port must be specified in options.';

  // Only TFramedNetServerTransport is supported
  var transport = /*options.transport ? options.transport :*/ ttransport.TFramedNetServerTransport;
