...
var Thrift = require('thrift/shared');

var Wrapper = module.exports.Wrapper = function(service_name, protocol, connection) {
...
var Multiplexer = module.exports.Multiplexer = function() {
    this.seqid = 0;
};
