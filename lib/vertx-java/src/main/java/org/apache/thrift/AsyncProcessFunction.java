...
public abstract class AsyncProcessFunction<I, T, R> {
  ...
  public abstract void start(I iface, T args, Future<R> future) throws TException;
  ...
  public void sendResponse(final TProtocol oprot, final TBase result, final byte type, final int seqid)
      throws TException {
